...
#ifndef VERILATED_VUNIVERSAL_SHIFT_REGISTER_H_
#define VERILATED_VUNIVERSAL_SHIFT_REGISTER_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vuniversal_shift_register VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  private:
    VL_UNCOPYABLE(Vuniversal_shift_register);  ///< Copying not allowed
